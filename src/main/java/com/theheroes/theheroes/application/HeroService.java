...
public class HeroService {
  ...
  public void prueba3cartas() {
    Hero heroe1 = new Hero("The Wasp", "https://cdn.marvel.com/content/1x/321whv_ons_crd_02.jpg",
        "The Wasp is a fictional superhero appearing in American comic books published by Marvel Comics.", 1960,
        "Marvel");
    saveHero(heroe1);
    // return "index";
  }
